...
public static class TeduEcommerceAdminPermissions
{
    ...
    {
        public const string Default = SystemGroupName + ".Product";
    ...
    {
        public const string Default = SystemGroupName + ".Attribute";
        public const string Create = Default + ".Create";
        public const string Update = Default + ".Update";
        public const string Delete = Default + ".Delete";
    }
